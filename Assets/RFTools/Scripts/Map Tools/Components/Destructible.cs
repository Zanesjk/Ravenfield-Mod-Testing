...
public class Destructible : MonoBehaviour {
	...
	public bool takeSplashDamage = false;
	public bool takesMeleeDamage = false;
	public bool takesCollisionDamage = false;
    [ConditionalField("takesCollisionDamage", true)] public float collisionDamageMultiplier = 1f;
