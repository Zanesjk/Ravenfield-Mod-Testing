...
public class MapExport {
	...
	public static string GetExportFilePath(Scene scene) {
		return $"{Paths.ProjectPath()}{PATH}/{GetExportFileName(scene)}";
	}
	...
	public static bool BuildBundle(BuildTarget buildTarget, out string filepath, bool ignoreGraphCacheWarning) {
		...
		string exportPath = GetExportFilePath(currentScene);
