...
public class WeaponUser : MonoBehaviour {
	...
	TimedAction reflectionDuckAction = new TimedAction(0.25f);
	...
	TimedAction fpKickAction = new TimedAction(0.2f);
	TimedAction weaponSnapAction = new TimedAction(0.5f);
