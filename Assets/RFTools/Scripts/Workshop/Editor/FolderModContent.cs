...
public class FolderModContent {
	...
	public static readonly string[] CONTENT_EXTENSIONS = {".rfl", ".rfc", ".rgc", ".rfld", ".patch"};
	public static readonly string[] ALLOWED_EXTENSIONS = {".txt", ".png", ".json", ".jpg", ".obj"};

	public string path;

	public List<FileInfo> allContent;
	public List<FileInfo> allMetaContent;
	...
	public void Scan() {
		...
		this.allMetaContent = new List<FileInfo>();
